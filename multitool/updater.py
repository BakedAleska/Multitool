...
Windows only: the app ships through installer/Multitool.iss's Inno Setup
...
GITHUB_RELEASES_API = "https://api.github.com/repos/BakedAleska/Multitool/releases/latest"
INSTALLER_ASSET_PATTERN = re.compile(r"^MultitoolSetup-.*\.exe$")
...
def download_installer(update: UpdateInfo) -> Path:
    ...
    """
    fd, tmp_name = tempfile.mkstemp(prefix="MultitoolSetup-", suffix=".exe")
