...
from multitool.widgets.process import stop_all_processes
...
def _build_icon_image() -> Image.Image:
    """Draw the tray icon: a rounded square with a white "M" on it.
...
def show(page: ft.Page) -> None:
    ...
    with _icon_lock:
        ...
        menu = pystray.Menu(
            pystray.MenuItem("Open Multitool", on_open, default=True),
            pystray.MenuItem("Quit", on_quit),
        )
        _icon = pystray.Icon("multitool", image, "Multitool", menu)
